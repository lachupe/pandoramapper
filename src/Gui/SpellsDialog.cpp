...
void SpellsDialog::save_clicked()
{
    ...
    spells[editing_index].name = lineEdit_name->text().toLocal8Bit();
    spells[editing_index].up_mes = lineEdit_up_mes->text().toLocal8Bit();
    spells[editing_index].refresh_mes = lineEdit_refresh_mes->text().toLocal8Bit();
    spells[editing_index].down_mes = lineEdit_down_mes->text().toLocal8Bit();
